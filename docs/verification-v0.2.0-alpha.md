...
- 窄屏筛选按钮移除易与文字重叠的箭头，弹出菜单增加动画、圆角和当前项提示；
- 项目水印设置入口及页面标题显示“此项目水印设置”；
...
- 大小：224,203,648 字节；
- SHA-256：`B51E8F1866E1276F94B403207F18A7BB13A97E7DE0ECB42B76F22D74415980E7`；
...
3. 在项目详情和全部记录中确认筛选按钮无文字重叠，菜单动画及当前项提示正常；
