...
- 做鸿蒙适配：只在 `ohos` 分支，先读交接文档 `docs/superpowers/handoffs/2026-08-20-ohos-agent-handoff.md`（自包含现状 / 硬红线 / 诚实边界 / 测试方法 / 下一步），再看 `README.md` 顶部与 `tool/ohos/full_product_gap.md`。禁止把社区 Flutter / `ohos/` 合进 `main`。引擎 degraded。已完成 Tasks 0–60。
