...
![Status](https://img.shields.io/badge/status-v0.5.0--prerelease-orange)

**当前版本：[`v0.5.0` 签名预发布版](https://github.com/WikG1018/site-mark/releases/tag/v0.5.0)**
...
| 安装包 | 适用设备 | 下载 |
| --- | --- | --- |
| arm64 | 推荐；绝大多数近年 Android 手机 | [下载 sitemark-v0.5.0-arm64.apk](https://github.com/WikG1018/site-mark/releases/download/v0.5.0/sitemark-v0.5.0-arm64.apk) |
| universal | 不确定处理器架构或 arm64 无法安装时使用；文件更大 | [下载 sitemark-v0.5.0-universal.apk](https://github.com/WikG1018/site-mark/releases/download/v0.5.0/sitemark-v0.5.0-universal.apk) |
| SHA-256 | 校验下载文件完整性 | [查看 SHA256SUMS.txt](https://github.com/WikG1018/site-mark/releases/download/v0.5.0/SHA256SUMS.txt) |
...
6. [Release 页面](https://github.com/WikG1018/site-mark/releases/tag/v0.5.0)提供版本说明和校验文件。
...
并在 [Release 页面](https://github.com/WikG1018/site-mark/releases/tag/v0.5.0)查看版本说明和校验文件。
