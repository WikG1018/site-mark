...
[![Latest](https://img.shields.io/badge/latest-v1.0.20-176B55)](https://github.com/WikG1018/site-mark/releases/tag/v1.0.20)
[![HarmonyOS](https://img.shields.io/badge/HarmonyOS-native--v1.0.12-E60012)](https://github.com/WikG1018/site-mark/releases/tag/native-v1.0.12)

**Current stable version (Latest): [`v1.0.20`](https://github.com/WikG1018/site-mark/releases/tag/v1.0.20)**

**Current HarmonyOS native version: [`native-v1.0.12`](https://github.com/WikG1018/site-mark/releases/tag/native-v1.0.12) (HarmonyOS NEXT, unsigned HAP)**

Requires Android 12 (API 31) or later. `v1.0.20` is set as Latest: Android smoothness fixes — list cards and pages drop the live BackdropFilter on Android (the bottom navigation dock keeps its real blur), page transitions switch to a single lightweight slide; the project detail top inset is fixed so capture records no longer sit under a large blank gap. The feature baseline remains the optional three-protocol NAS sync (WebDAV/SFTP/SMB, off by default, passwords in system secure storage). Back up important projects regularly — including the private original photos — and copy the backup files outside the app's directories.
...
| --- | --- | --- |
| arm64 | Recommended; almost all recent Android phones | [sitemark-v1.0.20-arm64.apk](https://github.com/WikG1018/site-mark/releases/download/v1.0.20/sitemark-v1.0.20-arm64.apk) |
| universal | Use when the processor architecture is unknown or arm64 cannot be installed; larger file | [sitemark-v1.0.20-universal.apk](https://github.com/WikG1018/site-mark/releases/download/v1.0.20/sitemark-v1.0.20-universal.apk) |
| SHA-256 | Verify the integrity of downloaded files | [SHA256SUMS.txt](https://github.com/WikG1018/site-mark/releases/download/v1.0.20/SHA256SUMS.txt) |

### HarmonyOS native (native-v1.0.12)

| Package | Applies to / notes | Download |
| --- | --- | --- |
| HarmonyOS HAP | **Unsigned**; sign it yourself in a DevEco/hdc environment before installing. A production signature requires an AGC release certificate (see `tool/ohos-native/sign-hap.ps1`). The published HAP is a debug build variant (an unsigned release build cannot be installed directly) | [sitemark-native-v1.0.12-unsigned.hap](https://github.com/WikG1018/site-mark/releases/download/native-v1.0.12/sitemark-native-v1.0.12-unsigned.hap) |
| HarmonyOS SHA-256 | Verify the integrity of downloaded files | [SHA256SUMS.txt](https://github.com/WikG1018/site-mark/releases/download/native-v1.0.12/SHA256SUMS.txt) |
...
- **v1.0.20 / native-v1.0.12** (Latest): Android smoothness fixes — list cards and pages drop the live BackdropFilter (the navigation dock keeps its real blur on Android), page transitions switch to a single lightweight slide; the project detail top inset is fixed.
...
- **v1.0.18 / native-v1.0.10**: after a two-finger zoom in fullscreen preview, one-finger pan can reach the right edge of the photo; list pages hide the top and bottom bars on scroll down and show them again on scroll up.
