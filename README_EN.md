...
**Current stable version (Latest): [`v1.0.27`](https://github.com/WikG1018/site-mark/releases/tag/v1.0.27)**
...
Requires Android 12 (API 31) or later. `v1.0.27` is set as Latest: NAS two-way (pick projects to import from NAS; delete sync); smaller release APKs via R8, Rust strip/LTO, and dropping 32-bit ARM. Back up important projects regularly — including the private original photos — and copy the backup files outside the app's directories.
...
| --- | --- | --- |
| arm64 | Recommended; almost all recent Android phones | [sitemark-v1.0.27-arm64.apk](https://github.com/WikG1018/site-mark/releases/download/v1.0.27/sitemark-v1.0.27-arm64.apk) |
| universal | Use when the processor architecture is unknown or arm64 cannot be installed; larger file | [sitemark-v1.0.27-universal.apk](https://github.com/WikG1018/site-mark/releases/download/v1.0.27/sitemark-v1.0.27-universal.apk) |
| SHA-256 | Verify the integrity of downloaded files | [SHA256SUMS.txt](https://github.com/WikG1018/site-mark/releases/download/v1.0.27/SHA256SUMS.txt) |
...
- **v1.0.27** (Latest): NAS two-way import picker and delete sync; smaller APKs via R8, drop armv7, Rust strip.
