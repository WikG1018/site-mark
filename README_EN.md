...
**Current stable version (Latest): [`v1.0.26`](https://github.com/WikG1018/site-mark/releases/tag/v1.0.26)**
...
Requires Android 12 (API 31) or later. `v1.0.26` is set as Latest: major NAS reliability and UX work (exponential backoff, fatal-error stop, background catch-up, failure notifications with one-tap fixes, one-way/two-way picker, usage help, streamed single-connection SFTP uploads); glass chrome opacity unified across dock / FAB / toast / batch bar. Back up important projects regularly — including the private original photos — and copy the backup files outside the app's directories.
...
| --- | --- | --- |
| arm64 | Recommended; almost all recent Android phones | [sitemark-v1.0.26-arm64.apk](https://github.com/WikG1018/site-mark/releases/download/v1.0.26/sitemark-v1.0.26-arm64.apk) |
| universal | Use when the processor architecture is unknown or arm64 cannot be installed; larger file | [sitemark-v1.0.26-universal.apk](https://github.com/WikG1018/site-mark/releases/download/v1.0.26/sitemark-v1.0.26-universal.apk) |
| SHA-256 | Verify the integrity of downloaded files | [SHA256SUMS.txt](https://github.com/WikG1018/site-mark/releases/download/v1.0.26/SHA256SUMS.txt) |
...
- **v1.0.26** (Latest): NAS backoff/background drain/failure alerts/two-way picker and usage help; streamed single-connection SFTP uploads; unified glass chrome opacity.
