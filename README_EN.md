...
**Current stable version (Latest): [`v1.0.17`](https://github.com/WikG1018/site-mark/releases/tag/v1.0.17)**

**Current HarmonyOS native version: [`native-v1.0.9`](https://github.com/WikG1018/site-mark/releases/tag/native-v1.0.9) (HarmonyOS NEXT, unsigned HAP)**

Requires Android 12 (API 31) or later. `v1.0.17` is set as Latest: About and first-launch privacy copy now match optional NAS sync; the HarmonyOS settings form gets the same spacing and protocol segmented control; leftover NAS queue, Android 17 LAN permission, and fingerprint-persist bugs are fixed; wifi-only drains resume when Wi-Fi returns; HarmonyOS queue counts update live. The feature baseline remains the optional three-protocol NAS sync (WebDAV/SFTP/SMB, off by default, passwords in system secure storage). Back up important projects regularly — including the private original photos — and copy the backup files outside the app's directories.
...
| --- | --- | --- |
| arm64 | Recommended; almost all recent Android phones | [sitemark-v1.0.17-arm64.apk](https://github.com/WikG1018/site-mark/releases/download/v1.0.17/sitemark-v1.0.17-arm64.apk) |
| universal | Use when the processor architecture is unknown or arm64 cannot be installed; larger file | [sitemark-v1.0.17-universal.apk](https://github.com/WikG1018/site-mark/releases/download/v1.0.17/sitemark-v1.0.17-universal.apk) |
| SHA-256 | Verify the integrity of downloaded files | [SHA256SUMS.txt](https://github.com/WikG1018/site-mark/releases/download/v1.0.17/SHA256SUMS.txt) |

### HarmonyOS native (native-v1.0.9)

| Package | Applies to / notes | Download |
| --- | --- | --- |
| HarmonyOS HAP | **Unsigned**; sign it yourself in a DevEco/hdc environment before installing. A production signature requires an AGC release certificate (see `tool/ohos-native/sign-hap.ps1`). The published HAP is a debug build variant (an unsigned release build cannot be installed directly) | [sitemark-native-v1.0.9-unsigned.hap](https://github.com/WikG1018/site-mark/releases/download/native-v1.0.9/sitemark-native-v1.0.9-unsigned.hap) |
| HarmonyOS SHA-256 | Verify the integrity of downloaded files | [SHA256SUMS.txt](https://github.com/WikG1018/site-mark/releases/download/native-v1.0.9/SHA256SUMS.txt) |
