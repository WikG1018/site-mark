...
class $CaptureTemplatesTable extends CaptureTemplates
    with TableInfo<$CaptureTemplatesTable, CaptureTemplate> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $CaptureTemplatesTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'capture_templates';
  @override
  VerificationContext validateIntegrity(
    Insertable<CaptureTemplate> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  @override
  CaptureTemplate map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  $CaptureTemplatesTable createAlias(String alias) {
    return $CaptureTemplatesTable(attachedDatabase, alias);
  }
}

class CaptureTemplate extends DataClass implements Insertable<CaptureTemplate> {
  final String id;
  final String projectId;
  final String name;
  ...
  CaptureTemplatesCompanion toCompanion(bool nullToAbsent) {
    return CaptureTemplatesCompanion(
      id: Value(id),
      projectId: Value(projectId),
      name: Value(name),
  ...
  factory CaptureTemplate.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  CaptureTemplate copyWithCompanion(CaptureTemplatesCompanion data) {
    return CaptureTemplate(
      id: data.id.present ? data.id.value : this.id,
      projectId: data.projectId.present ? data.projectId.value : this.projectId,
      name: data.name.present ? data.name.value : this.name,
  ...
  @override
  String toString() {
    return (StringBuffer('CaptureTemplate(')
          ..write('id: $id, ')
          ..write('projectId: $projectId, ')
          ..write('name: $name, ')
...
class CaptureTemplatesCompanion extends UpdateCompanion<CaptureTemplate> {
  final Value<String> id;
  final Value<String> projectId;
  final Value<String> name;
  ...
  final Value<DateTime> updatedAt;
  final Value<int> rowid;
  const CaptureTemplatesCompanion({
    this.id = const Value.absent(),
    this.projectId = const Value.absent(),
    this.name = const Value.absent(),
  ...
  CaptureTemplatesCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       createdAt = Value(createdAt),
       updatedAt = Value(updatedAt);
  static Insertable<CaptureTemplate> custom({
    Expression<String>? id,
    Expression<String>? projectId,
    Expression<String>? name,
  ...
  CaptureTemplatesCompanion copyWith({
    Value<String>? id,
    Value<String>? projectId,
    Value<String>? name,
  ...
  @override
  String toString() {
    return (StringBuffer('CaptureTemplatesCompanion(')
          ..write('id: $id, ')
          ..write('projectId: $projectId, ')
          ..write('name: $name, ')
          ..write('nameKey: $nameKey, ')
...
final class $$ProjectsTableReferences
  ...
  static MultiTypedResultKey<$CaptureTemplatesTable, List<CaptureTemplate>>
  _captureTemplatesRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.captureTemplates,
    aliasName: 'projects__id__capture_templates__project_id',
  );

  $$CaptureTemplatesTableProcessedTableManager get captureTemplatesRefs {
    final manager = $$CaptureTemplatesTableTableManager(
      $_db,
      $_db.captureTemplates,
    ).filter((f) => f.projectId.id.sqlEquals($_itemColumn<String>('id')!));

    final cache = $_typedResult.readTableOrNull(
      _captureTemplatesRefsTable($_db),
    );
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
...
class $$ProjectsTableFilterComposer
  ...
  Expression<bool> captureTemplatesRefs(
    Expression<bool> Function($$CaptureTemplatesTableFilterComposer f) f,
  ) {
    final $$CaptureTemplatesTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.captureTemplates,
      getReferencedColumn: (t) => t.projectId,
      builder:
          (
            joinBuilder, {
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$CaptureTemplatesTableFilterComposer(
            $db: $db,
            $table: $db.captureTemplates,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
            $removeJoinBuilderFromRootComposer:
                $removeJoinBuilderFromRootComposer,
...
class $$ProjectsTableAnnotationComposer
  ...
  Expression<T> captureTemplatesRefs<T extends Object>(
    Expression<T> Function($$CaptureTemplatesTableAnnotationComposer a) f,
  ) {
    final $$CaptureTemplatesTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.captureTemplates,
      getReferencedColumn: (t) => t.projectId,
      builder:
          (
            ...
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$CaptureTemplatesTableAnnotationComposer(
            $db: $db,
            $table: $db.captureTemplates,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
    ...
    extends
        RootTableManager<
          ...
          PrefetchHooks Function({
            bool captureRecordsRefs,
            bool captureTemplatesRefs,
          })
        > {
    ...
    : super(
        TableManagerState(
          ...
          prefetchHooksCallback:
              ({captureRecordsRefs = false, captureTemplatesRefs = false}) {
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [
                    if (captureRecordsRefs) db.captureRecords,
                    if (captureTemplatesRefs) db.captureTemplates,
                  ],
                  addJoins: null,
                    ...
                    return [
                      ...
                      if (captureTemplatesRefs)
                        ...
                        >(
                          currentTable: table,
                          referencedTable: $$ProjectsTableReferences
                              ._captureTemplatesRefsTable(db),
                          managerFromTypedResult: (p0) =>
                              $$ProjectsTableReferences(
                                db,
                                table,
                                p0,
                              ).captureTemplatesRefs,
                          referencedItemsForCurrentItem:
                              (item, referencedItems) => referencedItems.where(
                                (e) => e.projectId == item.id,
                              ),
...
typedef $$AppSettingsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$CaptureTemplatesTableCreateCompanionBuilder =
    CaptureTemplatesCompanion Function({
      required String id,
      required String projectId,
      required String name,
      required String nameKey,
...
typedef $$CaptureTemplatesTableUpdateCompanionBuilder =
    CaptureTemplatesCompanion Function({
      Value<String> id,
      Value<String> projectId,
      Value<String> name,
...
final class $$CaptureTemplatesTableReferences
    extends
        BaseReferences<_$AppDatabase, $CaptureTemplatesTable, CaptureTemplate> {
  $$CaptureTemplatesTableReferences(
    super.$_db,
    super.$_table,
    super.$_typedResult,
  );
  ...
  static $ProjectsTable _projectIdTable(_$AppDatabase db) =>
      db.projects.createAlias('capture_templates__project_id__projects__id');
...
class $$CaptureTemplatesTableFilterComposer
    extends Composer<_$AppDatabase, $CaptureTemplatesTable> {
  $$CaptureTemplatesTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$CaptureTemplatesTableOrderingComposer
    extends Composer<_$AppDatabase, $CaptureTemplatesTable> {
  $$CaptureTemplatesTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$CaptureTemplatesTableAnnotationComposer
    extends Composer<_$AppDatabase, $CaptureTemplatesTable> {
  $$CaptureTemplatesTableAnnotationComposer({
    required super.$db,
    required super.$table,
...
class $$CaptureTemplatesTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $CaptureTemplatesTable,
          CaptureTemplate,
          $$CaptureTemplatesTableFilterComposer,
          $$CaptureTemplatesTableOrderingComposer,
          $$CaptureTemplatesTableAnnotationComposer,
          $$CaptureTemplatesTableCreateCompanionBuilder,
          $$CaptureTemplatesTableUpdateCompanionBuilder,
          (CaptureTemplate, $$CaptureTemplatesTableReferences),
          CaptureTemplate,
          PrefetchHooks Function({bool projectId})
        > {
  $$CaptureTemplatesTableTableManager(
    _$AppDatabase db,
    $CaptureTemplatesTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$CaptureTemplatesTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$CaptureTemplatesTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$CaptureTemplatesTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> id = const Value.absent(),
                Value<String> projectId = const Value.absent(),
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$CaptureTemplatesTableReferences(db, table, e),
                ),
              )
              .toList(),
          prefetchHooksCallback: ({projectId = false}) {
...
typedef $$CaptureTemplatesTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $CaptureTemplatesTable,
      CaptureTemplate,
